<footer class="w-full bg-white text-brownie border-t border-cream mt-auto">
    <div class="max-w-7xl mx-auto px-6 md:px-12 py-20 w-full">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-16">
            ...
            <div class="flex flex-col gap-5">
                <a href="{{ route('home') }}" wire:navigate class="flex items-center gap-3">
                    <img src="{{ asset('logo.png') }}" alt="NDS Security Logo" class="h-12 w-auto object-contain" />
                </a>
                <p class="text-base text-coffee/90 leading-relaxed font-medium">
                ...
                <div class="flex items-center gap-3.5 mt-2">
                    @if(setting('facebook'))
                        <a href="{{ setting('facebook') }}" target="_blank" class="w-10 h-10 rounded-full bg-cream/40 border border-cream/80 hover:bg-caramel hover:text-white hover:border-caramel text-coffee flex items-center justify-center transition-all duration-300 shadow-sm" title="Facebook">
                            <i class="ri-facebook-fill text-lg"></i>
                        </a>
                    @endif
                    @if(setting('instagram'))
                        <a href="{{ setting('instagram') }}" target="_blank" class="w-10 h-10 rounded-full bg-cream/40 border border-cream/80 hover:bg-caramel hover:text-white hover:border-caramel text-coffee flex items-center justify-center transition-all duration-300 shadow-sm" title="Instagram">
                            <i class="ri-instagram-line text-lg"></i>
                        </a>
                    @endif
                    @if(setting('x'))
                        <a href="{{ setting('x') }}" target="_blank" class="w-10 h-10 rounded-full bg-cream/40 border border-cream/80 hover:bg-caramel hover:text-white hover:border-caramel text-coffee flex items-center justify-center transition-all duration-300 shadow-sm" title="X (Twitter)">
                            <i class="ri-twitter-x-line text-lg"></i>
                        </a>
                    @endif
                    @if(setting('whatsapp_number'))
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', setting('whatsapp_number')) }}" target="_blank" class="w-10 h-10 rounded-full bg-cream/40 border border-cream/80 hover:bg-caramel hover:text-white hover:border-caramel text-coffee flex items-center justify-center transition-all duration-300 shadow-sm" title="WhatsApp">
                            <i class="ri-whatsapp-line text-lg"></i>
                        </a>
                    @endif
                    <a href="mailto:{{ setting('email', 'info@ndssecurityservices.com') }}" class="w-10 h-10 rounded-full bg-cream/40 border border-cream/80 hover:bg-caramel hover:text-white hover:border-caramel text-coffee flex items-center justify-center transition-all duration-300 shadow-sm" title="Email">
            ...
            <!-- Quick Links -->
            <div>
                <h4 class="text-base font-black tracking-wider text-brownie uppercase mb-6">Quick Links</h4>
                <ul class="flex flex-col gap-3.5 text-base font-medium text-coffee/85">
            ...
            <!-- Services -->
            <div>
                <h4 class="text-base font-black tracking-wider text-brownie uppercase mb-6">Our Services</h4>
                <ul class="flex flex-col gap-3.5 text-base font-medium text-coffee/85">
            ...
            <div class="flex flex-col gap-4">
                <h4 class="text-base font-black tracking-wider text-brownie uppercase mb-6">Contact Details</h4>
                <div class="flex items-start gap-3.5 text-base">
                    <i class="ri-map-pin-line text-caramel text-xl mt-0.5 shrink-0"></i>
                ...
                <div class="flex items-center gap-3.5 text-base">
                    <i class="ri-phone-line text-caramel text-xl shrink-0"></i>
                ...
                <div class="flex items-center gap-3.5 text-base">
                    <i class="ri-mail-line text-caramel text-xl shrink-0"></i>
                ...
                @if(setting('office_time'))
                    <div class="flex items-center gap-3.5 text-base">
                        <i class="ri-time-line text-caramel text-xl shrink-0"></i>
        ...
        <!-- Footer Bottom Bar -->
        <div class="border-t border-cream mt-14 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-coffee/80 font-medium">
