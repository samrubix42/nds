<div class="w-full bg-white flex flex-col">
    ...
    <section x-data="{ 
        activeSlide: 0, 
        fallbackImage: '{{ asset('image/security-1.webp') }}',
        slides: [
            {
                ...
                image: '{{ asset('image/security-1.webp') }}',
    ...
    class="relative w-full min-h-[580px] h-screen sm:h-screen pt-20 sm:pt-28 md:pt-32 pb-16 bg-gradient-to-r from-[#2a1b10] via-brownie to-[#1a120b] overflow-hidden group select-none flex items-center">
        ...
        <template x-for="(slide, index) in slides" :key="index">
            <div x-show="activeSlide === index"
                ...
                <!-- Soft Light Vignette Overlays (Reduced Black Shadow Opacity) -->
                <div class="absolute inset-0 bg-gradient-to-r from-black/55 via-black/30 to-black/10 sm:from-black/45 sm:via-black/20 sm:to-transparent"></div>
            ...
            <div class="max-w-xl lg:max-w-2xl flex flex-col gap-3 sm:gap-4">
                <template x-for="(slide, index) in slides" :key="index">
                    <div x-show="activeSlide === index"
                        ...
                        <h1 class="text-4xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-tight text-white leading-tight drop-shadow-sm" x-text="slide.title"></h1>

                        <!-- Fully Responsive Subtitle -->
                        <p class="text-lg sm:text-base md:text-lg text-cream/90 font-medium leading-relaxed max-w-xl drop-shadow-sm" x-text="slide.subtitle"></p>
